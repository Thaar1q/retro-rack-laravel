...
@section('title', 'Tulis Artikel Baru - Admin RetroRack')
...
<div class="admin-header-row" style="margin-bottom: 24px;">
    <div>
        ...
        <h1 class="admin-page-title serif">Tulis Artikel Baru</h1>
        <p class="admin-page-subtitle">Bagikan pengetahuan tentang perangkat retro ke komunitas.</p>
    </div>
</div>

<form action="{{ route('admin.artikel.store') }}" method="POST" enctype="multipart/form-data" class="admin-form-container">
    @csrf
    <div class="admin-form-main">
        <div class="admin-form-section">
            ...
            <div class="admin-form-group">
                ...
                <input type="text" name="title" class="admin-form-input" placeholder="Contoh: Panduan Merawat Kamera Film Vintage" value="{{ old('title') }}" required>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                ...
                <div class="admin-form-group">
                    ...
                    <input type="text" name="tag" class="admin-form-input" placeholder="Gunakan koma untuk memisahkan" value="{{ old('tag') }}">
                </div>
            </div>
            ...
            <div class="admin-form-group">
                ...
                <textarea name="excerpt" class="admin-form-textarea" placeholder="Ringkasan singkat artikel (2-3 kalimat)..." style="min-height: 80px;">{{ old('excerpt') }}</textarea>
            </div>
        </div>
        ...
        <div class="admin-form-section">
            ...
            <div style="border: 1px solid var(--color-border); border-radius: 8px; overflow: hidden;">
                <textarea id="article-body" name="body" required>{{ old('body') }}</textarea>
            </div>
        ...
        <div class="admin-sidebar-card">
            ...
            <div class="admin-form-group">
                ...
                <select name="is_published" class="admin-form-input">
                    ...
                    <option value="1" {{ old('is_published', '1') == '1' ? 'selected' : '' }}>Terbit</option>
                </select>
            </div>
            ...
            <a href="{{ route('admin.artikel') }}" class="btn btn-outline" style="width: 100%; padding: 12px; display: inline-block; text-align: center;">Batal</a>
        </div>
