...
@section('title', 'Tambah Pengguna - Admin RetroRack')
...
<div class="admin-header-row" style="margin-bottom: 24px;">
    <div>
        ...
        <h1 class="admin-page-title serif">Tambah Pengguna</h1>
        <p class="admin-page-subtitle">Kelola akses dan informasi personil platform RetroRack.</p>
    </div>
</div>

<form action="{{ route('admin.pengguna.store') }}" method="POST" class="admin-form-container">
    @csrf
    <div class="admin-form-main">
        <div class="admin-form-section">
            ...
            <div class="admin-form-group">
                ...
                <input type="text" name="name" class="admin-form-input" placeholder="Contoh: Ahmad Riadi" value="{{ old('name') }}" required>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                <div class="admin-form-group">
                    ...
                    <input type="email" name="email" class="admin-form-input" placeholder="email@example.com" value="{{ old('email') }}" required>
                </div>
                <div class="admin-form-group">
