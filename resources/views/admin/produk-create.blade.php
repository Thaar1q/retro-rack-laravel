...
@section('title', 'Tambah Produk Baru - Admin RetroRack')
...
<div class="admin-header-row" style="margin-bottom: 24px;">
    <div>
        ...
        <h1 class="admin-page-title serif">Tambah Produk Baru</h1>
        <p class="admin-page-subtitle">Lengkapi informasi produk retro Anda ke dalam katalog marketplace.</p>
    </div>
</div>

<form action="{{ route('admin.produk.store') }}" method="POST" enctype="multipart/form-data" class="admin-form-container">
    @csrf
    <div class="admin-form-main">
        <div class="admin-form-section">
            ...
            <div class="admin-form-group">
                ...
                <input type="text" name="name" class="admin-form-input" placeholder="Contoh: Canon AE-1 Program" value="{{ old('name') }}" required>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                ...
                <div class="admin-form-group">
                    ...
                    <input type="number" name="year" class="admin-form-input" placeholder="1981" value="{{ old('year', date('Y')) }}" required>
                </div>
            </div>
            ...
            <div class="admin-form-group">
                ...
                <select name="condition" class="admin-form-input" required>
                    ...
                    <option value="mint" {{ old('condition') == 'mint' ? 'selected' : '' }}>Mint / Like New</option>
            ...
            <div class="admin-form-group">
                ...
                <textarea name="description" class="admin-form-textarea" placeholder="Jelaskan kondisi dan detail produk secara lengkap..." required>{{ old('description') }}</textarea>
            </div>
        </div>
        ...
        <div class="admin-form-section">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                <div class="admin-form-group">
                    ...
                    <input type="number" name="price" class="admin-form-input" placeholder="2500000" value="{{ old('price') }}" required>
                </div>
                <div class="admin-form-group">
                    ...
                    <input type="number" name="stock" class="admin-form-input" placeholder="1" value="{{ old('stock', 1) }}" required>
                </div>
            </div>
        </div>
    ...
    <div class="admin-form-sidebar">
        <div class="admin-sidebar-card">
            ...
            <button type="submit" class="btn btn-dark" style="width: 100%; margin-bottom: 12px; padding: 12px;">Simpan Produk</button>
